...
const Registrar = () => {
  /*Se crean los campos para el registro con el use state iniciando vacios*/
  ...
  const handleSubmit = async e => {
      e.preventDefault();
      /*Se guardan las variables en un arreglo y con el metodo includes valida si hay algun campo vacio*/
      ...
      try {          
          //Se deben instalar CORS  para que la api interactue con dominios diferentes
          //Para poder usarla desde cualquier frontend
          //Se debe instalar npm i cors en la terminal
