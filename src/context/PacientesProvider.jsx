    ...
    const guardarPaciente = async (paciente) => {
        ...
        if(paciente.id){
            try {
                ...
                console.log(MediaRecorderErrorEvent)
            }
        }else{            
            try {
                //Se pasa el post con autenticacion
                const { data } = await clienteAxios.post('/pacientes',paciente, config)
    
                //Crea un nuevo objeto omitiendo los valores de cretedAt, updatedAt y __v de la respuesta
